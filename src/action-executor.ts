...
const ACTION_COOLDOWNS_MS: Record<ActionType, number> = {
  none: 0,
  "send-message": 3 * 60 * 1000,
  "learn-topic": 30 * 60 * 1000,
  "search-web": 8 * 60 * 1000,
  "self-reflect": 5 * 60 * 1000,
  "recall-memory": 20 * 60 * 1000,
  "create-goal": 30 * 60 * 1000,
  "invoke-tool": 5 * 60 * 1000,
  "analyze-problem": 20 * 60 * 1000,
  "run-agent-task": 40 * 60 * 1000,
  "report-findings": 2 * 60 * 1000,
  "observe-and-improve": 30 * 60 * 1000,
  "subagent-improve": 40 * 60 * 1000,
  "proactive-research": 30 * 60 * 1000,
  "proactive-content-push": 60 * 60 * 1000,
  "proactive-check-in": 8 * 60 * 1000,
};

const MIN_ACTION_COOLDOWNS_MS: Partial<Record<ActionType, number>> = {
  "learn-topic": 10 * 60 * 1000,
  "recall-memory": 10 * 60 * 1000,
  "analyze-problem": 8 * 60 * 1000,
  "run-agent-task": 20 * 60 * 1000,
  "observe-and-improve": 15 * 60 * 1000,
  "subagent-improve": 20 * 60 * 1000,
  "report-findings": 30 * 1000,
  "proactive-research": 15 * 60 * 1000,
  "proactive-content-push": 20 * 60 * 1000,
  "proactive-check-in": 3 * 60 * 1000,
};
